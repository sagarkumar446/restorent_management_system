...
import edu.qsp.restorent_management_system.service.ReservationService;
...
public class TableController {
    ...
    @PostMapping("reserve_table/{id}")
    public SittingTable postMethodName(@PathVariable Integer id) {

       return   reservationService.reservTable(id);
